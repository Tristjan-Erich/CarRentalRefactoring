...
const server = http.createServer(function(request, response) {
    ...
    if (request.method == 'POST') {
        ...
        request.on('end', function() {
            ...
            console.log(post);
            const result = rental.price(Number(post.age), Number(post.licenceHeld), Number(post.clazz), parseBool(post.accidentCaused), parseBool(post.season))
            console.log(result);
            ...
            <html>
                <body>
                    <form id="calcForm" method="post" action="http://localhost:3000">Driver: <br>
                        ...
                        <input type="number" name="licenceHeld" />
                        ...
                        <input type=checkbox name="accidentCaused" />
